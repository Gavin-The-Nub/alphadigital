...
export function ChangelogList({ changelogPosts }: { changelogPosts: any[] }) {
        ...
        >
          <div className="relative flex w-[110px] shrink-0 items-start justify-between">
            ...
            >
              <div
                className={clsx(
                  "box-shadow-neon absolute -left-[3.5px] top-0 size-2 transform rounded-full bg-[--grayscale-400] shadow-[--grayscale-400-10] transition-all dark:bg-[--grayscale-600] dark:shadow-[--grayscale-600-20]",
                  {
